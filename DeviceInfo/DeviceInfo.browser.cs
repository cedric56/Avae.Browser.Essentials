...
namespace Microsoft.Maui.Devices
{
    public partial class DeviceInfoImplementation : IDeviceInfo
    {
        ...
        public async void Initialize()
        {
            ...
            var info = JsonConvert.DeserializeObject<BrowserInfo>(infos);
            if (info == null)
                return;

            

            browserInfo.BrowserMajor = info.BrowserMajor;
            browserInfo.BrowserName = info.BrowserName;
            browserInfo.BrowserVersion = info.BrowserVersion;
            browserInfo.DeviceModel = info.DeviceModel;
            browserInfo.DeviceType = info.DeviceType;
            browserInfo.DeviceVendor = info.DeviceVendor;
            browserInfo.EngineName = info.EngineName;
            browserInfo.EngineVersion = info.EngineVersion;
            browserInfo.GPURenderer = info.GPURenderer;
            browserInfo.GPUVendor = info.GPUVendor;
            browserInfo.IP = info.IP;
            browserInfo.IsAndroid = info.IsAndroid;
            browserInfo.IsDesktop = info.IsDesktop;
            browserInfo.IsIPad = info.IsIPad;
            browserInfo.IsIPadPro = info.IsIPadPro;
            browserInfo.IsIPhone = info.IsIPhone;
            browserInfo.IsMobile = info.IsMobile;
            browserInfo.IsTablet = info.IsTablet;
            browserInfo.OSName = info.OSName;
            browserInfo.OSVersion = info.OSVersion;
            browserInfo.ScreenResolution = info.ScreenResolution;
            browserInfo.TimeZone = info.TimeZone;
