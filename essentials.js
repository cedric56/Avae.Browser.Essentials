...
//// Example: use methods from dotnetRuntime
...
export const mediaCapture = {
    sendBlobToDotNet: async function (blobUrl) {
        ...
        // Assuming a global C# method is available via JSExport
        // This could be something like: DotNet.invokeMethod or JSExported function depending on setup
    ...
    capturePhotoInPopup: function () {
        return new Promise((resolve, reject) => {
            var popupWindow = window.open("", "PhotoCapture", "width=600,height=500");
            ...
            popupWindow.document.write(`
                ...
                <body>
                    <h3>Capture Photo</h3>
                    <video id="videoPreview" autoplay playsinline style="width:100%; max-height:300px;"></video>
                    <br>
                    ...
                    <script>
                        ...
                        async function startCamera() {
                            try {
                                ...
                                window.opener.photoCaptureCallback(null);
                                window.close();
                            }
                        }
                        ...
                        function acceptPhoto() {
                            ...
                            canvas.toBlob(function (blob) {
                                ...
                                window.opener.photoCaptureCallback(imageUrl); // send back image URL
                                window.close();
                            }, "image/png");
                        }
                        ...
                        document.getElementById("acceptPhoto").addEventListener("click", acceptPhoto);
                        document.getElementById("rejectPhoto").addEventListener("click", rejectPhoto);
            ...
            // Receive the accepted photo blob URL from the popup
            window.photoCaptureCallback = function (imageUrl) {
                if (imageUrl) {
                    resolve(imageUrl);
                } else {
                    reject("Photo capture failed.");
                }
            };
        });
    },
    captureVideoInPopup: function () {
        return new Promise((resolve, reject) => {
            var popupWindow = window.open("", "VideoCapture", "width=800,height=600");
                    ...
                    <script>
                        ...
                        async function startCapture() {
                            try {
                                ...
                                window.opener.videoCaptureCallback(null);
                                window.close();
                            }
                        }
                        ...
                        function acceptCapture() {
                            ...
                            window.opener.videoCaptureCallback(videoUrl); // Send video URL to Blazor
                            window.close();
                        }
                        ...
                        document.getElementById("acceptRecording").addEventListener("click", acceptCapture);
                        document.getElementById("rejectRecording").addEventListener("click", rejectCapture);
                    </script>
                </body>
                </html>
            `);

            window.videoCaptureCallback = function (videoUrl) {
                if (videoUrl) {
                    resolve(videoUrl);
                } else {
                    reject("Video capture failed.");
                }
            };
        });
    }
...
export const openFilePickerInterop = {
    show: function () {
        return new Promise(async (resolve, reject) => {
            try {
